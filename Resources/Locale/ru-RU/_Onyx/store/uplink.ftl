...
uplink-sleeping-carp-desc = Свиток с секретами древней боевой техники. Позволяет мастерски владеть рукопашным боем, с лёгкостью уклоняться от огня дальнобойного оружия, а космические карпы становятся дружелюбными. Ограничивает использование дальнобойного оружия.
