...
alert-level-epsilon-announcement = Объявлено исполнение протокола «Эпсилон». Все контракты расторгнуты. Бывшему персоналу приказано оказывать содействие оперативной группе. Спасибо, что выбрали корпорацию NanoTrasen.
