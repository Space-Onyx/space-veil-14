...
using Robust.Client.UserInterface.Controls; // <Onyx-StationTime-edited>
...
namespace Content.Client.PDA
{
    ...
    {
        [Dependency] private IClipboardManager _clipboard = null!; // <Onyx-StationTime-edited>
        ...
        public PdaMenu()
        {
            ...
            StationTimeButton.OnPressed += _ =>
            {
                ...
                _clipboard.SetText(_gameTicker.StationDateTime.ToString("HH:mm:ss"));
                // </Onyx-StationTime-edited>
            };
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            // <Onyx-StationTime-edited>
            StationTimeLabel.SetMarkup(Loc.GetString("comp-pda-ui-station-clock",
                ("time", _gameTicker.StationDateTime.ToString("HH:mm:ss"))));
            ShiftDurationLabel.SetMarkup(Loc.GetString("comp-pda-ui-station-time",
                ("time", FormatShiftDuration())));
            // </Onyx-StationTime-edited>
        ...
        // <Onyx-StationTime>
        private string FormatShiftDuration()
        {
