...
//
// Collection helper derived from RobustToolbox (https://github.com/space-wizards/RobustToolbox),
...
/// </summary>
internal sealed class ChatRingBufferList<T> : IList<T>
{
    private T[] _items;
    private int _read;
    private int _write;

    public ChatRingBufferList(int capacity)
    {
        _items = new T[capacity];
    }

    public ChatRingBufferList()
    {
        _items = [];
    }
    ...
    {
        private readonly ChatRingBufferList<T> _ringBufferList;
        private int _readPos;

        internal Enumerator(ChatRingBufferList<T> ringBufferList)
        {
