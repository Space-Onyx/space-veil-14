...
public sealed partial class BlobCoreComponent : Component
{
    ...
    public BlobChemDamage ChemDamageDict { get; set; } = new()
    {
        ...
        { BlobChemType.ComatoseFiber, new DamageSpecifier { DamageDict = new() { { "Structural", 150 }, { "Asphyxiation", 22 } } } },
        { BlobChemType.ChainCoating, new DamageSpecifier { DamageDict = new() { { "Structural", 150 }, { "Blunt", 12 }, { "Slash", 12 } } } },
        { BlobChemType.SinewyTendons, new DamageSpecifier { DamageDict = new() { { "Structural", 150 }, { "Blunt", -8 }, { "Slash", -8 }, { "Piercing", -8 }, { "Poison", -8 }, { "Heat", -8 }, { "Cold", -8 }, { "Asphyxiation", -8 } } } },
        { BlobChemType.CorrosiveSlime, new DamageSpecifier { DamageDict = new() { { "Structural", 320 }, { "Caustic", 13 }, { "Cellular", 2 } } } },
        { BlobChemType.CryogenicPoison, new DamageSpecifier { DamageDict = new() { { "Structural", 100 }, { "Cold", 16 }, { "Slash", 4 } } } },
    };
