...
public sealed partial class AutoDodgeSystem : EntitySystem
{
    ...
    private void OnHitscanReflect(Entity<AutoDodgeComponent> ent, ref HitScanReflectAttemptEvent args)
    {
        ...
        DoDodgeEffects(ent, args.Direction, ShouldFlip(ent, args.SourceItem));
    }
    ...
    private void OnGettingAttacked(Entity<AutoDodgeComponent> ent, ref GettingAttackedAttemptEvent args)
    {
        ...
        DoDodgeEffects(ent, direction, ShouldFlip(ent, args.Attacker));
    }
    ...
    private bool ShouldFlip(EntityUid dodger, EntityUid source)
    {
        return ((GetNetEntity(dodger).Id ^ GetNetEntity(source).Id) & 1) == 0;
    }
}
